...
|20.01|||[HW2](https://github.com/tbkazakova/DataAnalysis_2023/blob/main/HW2.md)|
|27.01||||
...
### Формула оценки:
0.2 * **КР по питону** + 0.2 * **среднее по ДЗ** + 0.2 * **мини-тесты на семинарах** + 0.2 * **исследовательский проект** + 0.2 * **ЭКЗ** 
